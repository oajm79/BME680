...
class Config:
    ...
    def storage_mode(self) -> str:
        """Get storage mode: 'sqlite' or 'csv'."""
        return self.get('data_logging.storage_mode', 'sqlite')

    @property
    def database_path(self) -> str:
        """Get SQLite database path."""
        return self.get('data_logging.database.path', 'data/sensor_data.db')

    @property
    def database_table(self) -> str:
        """Get SQLite table name."""
        return self.get('data_logging.database.table_name', 'measurements')

    @property
    def database_cleanup_days(self) -> int:
        """Get database cleanup days (0 to disable)."""
        return self.get('data_logging.database.cleanup_days', 90)

    @property
    def csv_filename(self) -> str:
        """Get CSV output filename."""
        return self.get('data_logging.csv.filename', 'measures.csv')

    @property
    def flush_immediately(self) -> bool:
        """Check if CSV should flush immediately after each write."""
        return self.get('data_logging.csv.flush_immediately', True)
    ...
    @property
    def telegram_rate_limit(self) -> int:
        """Get Telegram rate limit in seconds."""
        return self.get('telegram.rate_limit_seconds', 300)

    @property
    def telegram_quiet_hours_start(self) -> int:
        """Get Telegram quiet hours start (hour)."""
        return self.get('telegram.quiet_hours.start', None)

    @property
    def telegram_quiet_hours_end(self) -> int:
        """Get Telegram quiet hours end (hour)."""
        return self.get('telegram.quiet_hours.end', None)

    @property
    def telegram_alert_air_quality_poor(self) -> bool:
        """Check if air quality poor alerts are enabled."""
        return self.get('telegram.alerts.air_quality_poor', True)

    @property
    def telegram_alert_temperature_high(self) -> float:
        """Get high temperature alert threshold."""
        return self.get('telegram.alerts.temperature_high', None)

    @property
    def telegram_alert_temperature_low(self) -> float:
        """Get low temperature alert threshold."""
        return self.get('telegram.alerts.temperature_low', None)

    @property
    def telegram_alert_humidity_high(self) -> float:
        """Get high humidity alert threshold."""
        return self.get('telegram.alerts.humidity_high', None)

    @property
    def telegram_alert_humidity_low(self) -> float:
        """Get low humidity alert threshold."""
        return self.get('telegram.alerts.humidity_low', None)

    @property
    def telegram_daily_summary(self) -> bool:
        """Check if daily summary is enabled."""
        return self.get('telegram.alerts.daily_summary', True)

    @property
    def telegram_daily_summary_hour(self) -> int:
        """Get daily summary hour."""
        return self.get('telegram.alerts.daily_summary_hour', 20)

    @property
    def telegram_system_notifications(self) -> bool:
        """Check if system notifications are enabled."""
        return self.get('telegram.alerts.system_notifications', True)
    ...
    # Location configuration (for weather service)
    @property
    def location_enabled(self) -> bool:
        """Check if location/weather service is enabled."""
        return self.get('location.enabled', False)

    @property
    def location_latitude(self) -> float:
        """Get location latitude."""
        return self.get('location.latitude', None)

    @property
    def location_longitude(self) -> float:
        """Get location longitude."""
        return self.get('location.longitude', None)

    @property
    def location_name(self) -> str:
        """Get location name for display."""
        return self.get('location.name', 'Unknown')
